...
public class RegisterActivity extends AppCompatActivity
{
    ...
    {
        // Mendapatkan DAO dari DTSAppsDatabase
        UserDao daoUser = AppDbProvider.getInstance(this.getApplicationContext()).userDao();

        // Menggunakan Dao untuk insert data dalam objek dari class Entity User
    ...
    // Membuat Entity class baru berdasarkan isian user pada EditText-EditText
    private User makeUser() {
        ...
        u.phoneNumber = this.edtPassword.getText().toString();
